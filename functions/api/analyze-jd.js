...
const DEFAULT_REPORT = {
  ...
  highlights: [],
  risks: [],
  summary: "该岗位与候选人当前作品集的核心方向关联较弱。候选人的优势主要集中在 AI 产品、数据分析、统计背景和业务问题拆解方向，而该岗位的核心职责与这些能力的直接重合度有限。",
  roleRelevance: null,
};
...
7. 不要因为 JD 中出现 AI、AIGC、逻辑思维、信息结构化等泛化关键词就给出 90+ 高分。必须先判断岗位本身是否属于候选人的核心目标方向：AI 产品经理、数据分析师、数据产品、AI Agent 产品、业务分析、增长分析、产品数据分析。
8. 如果岗位主要是内容运营、课程制作、教育分发、社群运营、行政支持或销售支持，即使包含 AI 工具探索，也只能判定为相邻相关或弱相关，分数通常不应超过 83。
9. 只有当 JD 同时包含明确的产品 / 数据 / AI Agent / 指标分析 / SQL / Python / 用户需求 / 工作流等核心职责时，才可以给 90-95。
...
方向：AI Product & Data Analyst，AI 产品经理 / 数据分析师方向
GPA：3.7/4.0
...
技能：
AI Agent, LLM, Prompt Engineering, RAG, Tool Calling, Workflow Design, SQL, Python, Pandas, DuckDB, Excel, 数据分析, 指标体系, 可视化, 漏斗分析, 转化率分析, Top Movers, PRD, 用户流程, 产品原型, 竞品调研。

项目 1：SOVA AI｜AI 指标异动分析 Agent
...
项目 2：UCSD Triton Transit｜校园班车晚间服务缺口诊断与排班优化
