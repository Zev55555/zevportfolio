...
13. 不要因为 JD 中出现 AI、AIGC、逻辑思维、信息结构化等泛化关键词就给出 90+ 高分。必须先判断岗位本身是否属于候选人的核心目标方向：AI 产品经理、数据分析师、数据产品、AI Agent 产品、业务分析、增长分析、产品数据分析。
14. 如果岗位主要是内容运营、课程制作、教育分发、社群运营、行政支持或销售支持，即使包含 AI 工具探索，也只能判定为相邻相关或弱相关，分数通常不应超过 83。
15. 只有当 JD 同时包含明确的产品 / 数据 / AI Agent / 指标分析 / SQL / Python / 用户需求 / 工作流等核心职责时，才可以给 90–95。
